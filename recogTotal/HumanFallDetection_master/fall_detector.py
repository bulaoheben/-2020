...
class FallDetector:
    ...
    def cli(self):
        ...
        vis_args.add_argument('--save_output', default=True, action='store_true',
    ...
    def changeArgs(self, num_camera, save):
        self.args.num_cams = num_camera
        self.args.save_output = save
